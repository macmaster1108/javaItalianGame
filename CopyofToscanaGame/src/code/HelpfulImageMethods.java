package code;
//Utilizing the given code from Lab 8 in CSE 115, We take in a image from a file path. The subImage 
//method allows for our board to be cut into piece then assembled onto JLabels
